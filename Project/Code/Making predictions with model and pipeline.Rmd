---
title: "Making predictions with model and pipeline"
author: "Group F"
date: "`r Sys.Date()`"
output: pdf_document
---
...
new_records_df <- read.csv("new_records.csv")
```
...
```{r}
record_to_save$Eligible <- predVal

new_records_df <- rbind(new_records_df, record_to_save)

write.csv(new_records_df, "new_records.csv", row.names = FALSE)
```
